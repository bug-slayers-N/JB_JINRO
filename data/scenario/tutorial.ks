...
[tb_start_text mode=1 ]
#叶
「状況確認の通り、敬一君は嘘つきで確定だ」[p]
「嘘がつけるのは人狼と狂人だけだから、占い師COが3人いる時点で残りのオレとユミピコは村人確定」[p]
...
「人狼は礼二君で確定な訳だ」[p]
「あとは礼二君を疑って、みんなに処刑投票してもらうだけだな」[p]
[_tb_end_text]
...
「観察力の高いキャラを選んだり、怪しい者を積極的に疑いましょう」[p]
[_tb_end_text]
